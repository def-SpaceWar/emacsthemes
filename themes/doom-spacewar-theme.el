...
(def-doom-theme doom-spacewar
  ...
  ((bg         '("#141215" "black"       "black" ))
   ...
   (teal       '("#43AAB1" "#44b9b1" "brightgreen"     ))
   (yellow     '("#EECC54" "#ECBE7B" "yellow"          ))
   (blue       '("#55AAFF" "#51afef" "brightblue"      ))
   (dark-blue  '("#4499EE" "#2257A0" "blue"            ))
   ...
   (selection      violet)
   (builtin        red)
   (comments       (if doom-spacewar-brighter-comments (doom-lighten dark-cyan 0.2) teal))
   (doc-comments   (if doom-spacewar-brighter-comments (doom-lighten yellow 0.2) green))
   (constants      blue)
   (functions      cyan)
   (keywords       red)
   (methods        cyan)
  ...
  (((font-lock-comment-face &override)
   ...
   ;;;; outline <built-in>
   ((outline-1 &override) :foreground redtwo)
   ...
   ;;;; rainbow-delimiters
   (rainbow-delimiters-depth-1-face :foreground redtwo)
