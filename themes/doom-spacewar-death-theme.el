...
(def-doom-theme doom-spacewar-death
  ...
  ((bg         '("#222222" "black"       "black" ))
   ...
   (red        '("#FF5F5A" "#ff5577" "red"             ))
   (redtwo     '("#EE627F" "#ff6655" "red"             ))
   (redthree   '("#DD6D78" "#dd8844" "brightred"       ))
   (blue       '("#7F76FF" "#99bb66" "green"           ))
   (bluetwo    '("#7797EE" "#44b9b1" "brightgreen"     ))
   (bluethree  '("#7F88DD" "#ECBE7B" "yellow"          ))
