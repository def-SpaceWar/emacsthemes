...
(def-doom-theme doom-spacewar-death
  ...
  ((bg         '("#222222" "black"       "black" ))
   ...
   (base5      '("#888888" "#666666"     "brightblack" ))
   (base6      '("#999999" "#7b7b7b"     "brightblack" ))
   (base7      '("#AAAAAA" "#979797"     "brightblack" ))
   (base8      '("#CCCCCC" "#dfdfdf"     "white"       ))

   (grey       '("#555555" "#5e5e5e" "grey"            ))
   (red        '("#FF4F4A" "#ff5577" "red"             ))
   (redtwo     '("#EE526F" "#ff6655" "red"             ))
   (redthree   '("#DD5D68" "#dd8844" "brightred"       ))
   (blue       '("#6F66FF" "#99bb66" "green"           ))
   (bluetwo    '("#6787EE" "#44b9b1" "brightgreen"     ))
   (bluethree  '("#6F78DD" "#ECBE7B" "yellow"          ))
   (violet     '("#AA66FF" "#51afef" "brightblue"      ))
   (violettwo  '("#BF69DD" "#2257A0" "blue"            ))
   (magenta    '("#DD66FF" "#2257A0" "blue"            ))
   (yellow     '("#FFCC77" "#c678dd" "brightmagenta"   ))
   (green      '("#AAFF55" "#a9a1e1" "magenta"         ))
   (orange     '("#FF9944" "#46D9FF" "brightcyan"      ))
   (cyan       '("#55DDFF" "#5699AF" "cyan"            ))
   (dark-blue  '("#4444DD" "#5699AF" "cyan"            ))
   (dark-cyan  '("#227788" "#5699AF" "cyan"            ))
   (teal       '("#22AABB" "#5699AF" "cyan"            ))
